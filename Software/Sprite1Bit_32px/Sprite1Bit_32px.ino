...
delay(1000);
 ...
 tft.drawLine(30+x*42,40,30+x*42,240,TFT_BLACK);
 tft.drawLine(31+x*42,40,31+x*42,240,TFT_BLACK);
...
if (x==2){
 ...
 tft.fillRect(32+x*42,240-val-tab_height,40,tab_height,TFT_BLACK);
  tft.fillRect(32+x*42,240-val+1-tab_height,40,tab_height-2,TFT_GREEN);
...
} else
{
 ...
 tft.setFreeFont(FF17); 
 tft.setCursor (40+x*42,240-val+18-tab_height);
 tft.print(val,0);
  tft.setTextFont(0); 
   tft.setCursor (62+x*42,240-val-tab_height+3);
  tft.print("o");
  
if(x==1){
 tft.fillRect(32+x*42,240-val,40,val,TFT_GREEN);
   tft.setTextColor(TFT_BLACK,TFT_GREEN);
} else
{ tft.fillRect(32+x*42,240-val,40,val,TFT_DARKGREY);
 ...
 tft.drawLine(30+5*42,40,30+5*42,240,TFT_BLACK);
 tft.drawLine(31+5*42,40,31+5*42,240,TFT_BLACK);
