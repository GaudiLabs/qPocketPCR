...
void setup() {
  ...
  ESP_LOGI(TAG, "Get Total size %d KB in PSRAM", heap_caps_get_total_size(MALLOC_CAP_SPIRAM) );
  ESP_LOGI(TAG, "Get free size %d KB in PSRAM", heap_caps_get_free_size(MALLOC_CAP_SPIRAM) );
  ESP_LOGI(TAG, "Get minimum free size %d KB in PSRAM", heap_caps_get_minimum_free_size(MALLOC_CAP_SPIRAM) );
  ESP_LOGI(TAG, "Get largest free block %d KB in PSRAM", heap_caps_get_largest_free_block(MALLOC_CAP_SPIRAM) );
  ESP_LOGI(TAG, "Get minimum free size %d KB in DRAM", heap_caps_get_minimum_free_size(MALLOC_CAP_8BIT) );
delay(1000);
